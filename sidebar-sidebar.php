...
<div id="sidebar">
    <div id="sea-men">
        ...
        <a href="http://www.youtube.com/mikesinkula" title="Mike Sinkula's YouTube Channel" target="_blank"><img title="Mike Sinkula's YouTube Channel" src="<?php bloginfo('template_directory'); ?>/images/img-youtube.png" alt="Mike Sinkula's YouTube Channel"  /></a>
